/// A managed fungible asset module for Banana B tokens
/// When deployed, the deployer creates a new managed fungible asset with hardcoded supply config
module movement_staking::banana_b {
    ...
    use std::string::utf8;
    use std::option;
    friend movement_staking::tokenstaking;

    /// Only fungible asset metadata owner can make changes.
    const ENOT_OWNER: u64 = 1;

    const ASSET_SYMBOL: vector<u8> = b"BANANA_B";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            constructor_ref,
            option::none(),
            utf8(b"BANANA B | Movement Staking"), /* name */
            utf8(ASSET_SYMBOL), /* symbol */
            9, /* decimals */
            utf8(b"https://movement.xyz/images/banana_b.png"), /* icon */
            utf8(b"https://movement.xyz") /* project */
        );
    ...
    public fun get_metadata(): Object<Metadata> {
        let asset_address = object::create_object_address(&@movement_staking, ASSET_SYMBOL);

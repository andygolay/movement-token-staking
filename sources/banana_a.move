...
module movement_staking::banana_a {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BANANA_A";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            constructor_ref,
            option::none(),
            utf8(b"BANANA A | Movement Staking"), /* name */
            utf8(ASSET_SYMBOL), /* symbol */
            9, /* decimals */
            utf8(b"https://movement.xyz/images/banana_a.png"), /* icon */
